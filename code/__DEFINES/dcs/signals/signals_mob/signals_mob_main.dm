...
// SKYRAT EDIT BEGIN
/// From /mob/playsound_local(): ()
#define COMSIG_MOB_PLAYSOUND_LOCAL "mob_playsound_local"
	// used to access COMSIG_MOB_PLAYSOUND_LOCAL argslist
	#define PLAYSOUND_LOCAL_SOURCE 1
	#define PLAYSOUND_LOCAL_SOUNDIN 2
	#define PLAYSOUND_LOCAL_VOLUME 3
	#define PLAYSOUND_LOCAL_VARY 4
	#define PLAYSOUND_LOCAL_FREQUENCY 5
	#define PLAYSOUND_LOCAL_FALLOFF_EXPONENT 6
	#define PLAYSOUND_LOCAL_CHANNEL 7
	#define PLAYSOUND_LOCAL_PRESSURE 8
	#define PLAYSOUND_LOCAL_SOUND 9
	#define PLAYSOUND_LOCAL_MAX_DISTANCE 10
	#define PLAYSOUND_LOCAL_FALLOFF_DISANCE 11
	#define PLAYSOUND_LOCAL_DISTANCE_MULTIPLIER 12
	#define PLAYSOUND_LOCAL_USE_REVERB 13
// SKYRAT EDIT END
