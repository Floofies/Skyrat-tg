...
// Traits added by Quirks
#define TRAIT_CANINE "trait_canine" // Caninid trait
...
#define TRAIT_FELINE "feline_aspect" // Felinid traits
...
#define TRAIT_OVERSIZED "trait_oversized" /// If someone has the oversized quirk.
